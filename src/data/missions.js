...
export const MISSIONS = [
  ...
  },
  {
    id: 'black-relay',
    title: 'Black Relay',
    objective: 'Pénétrer le relais effacé black-07.',
    summary: 'Un relais clandestin pulse hors registre.',
    ...
    steps: [
      {
        ...
        currentObjective: 'Identifier le relais hors registre',
        target: 'black-07',
        protocol: 'SCAN',
        rpHint: 'Le protocole de surface répond encore. L\'empreinte doit précéder le tunnel.',
      ...
      },
      {
        ...
        currentObjective: 'Ouvrir le tunnel vers le relais',
        target: 'black-07',
        protocol: 'CONNECT',
        rpHint: 'La surface a répondu. Le relais refuse toute connexion non analysée.',
    ...
    steps: [
      {
        ...
        rpHintPurged: 'Un nom persiste dans le bruit. Les métadonnées sont incomplètes.',
