...
export const MISSIONS = [
  ...
  },
  {
    ...
    steps: [
      {
        ...
        nextStep: 'Analyser le relais black-07 via le terminal.',
        currentObjective: 'Localiser le relais black-07',
        target: 'black-07',
        protocol: 'SCAN',
        hint: 'Le message parle d\'un relais effacé des registres. Commencez par un scan.',
        rpHint: 'Le relais semble répondre au protocole SCAN.',
      ...
      },
      {
        ...
        nextStep: 'Ouvrir un tunnel vers black-07.',
        currentObjective: 'Établir la connexion au relais',
        target: 'black-07',
        protocol: 'CONNECT',
        hint: 'Le relais répond au scan. Établissez la connexion.',
    ...
    unlockMailsOnComplete: ['mail-archive-leak'],
  },
  {
    id: 'dead-archive',
    title: 'Archive Morte',
    ...
    steps: [
      {
        ...
        rpHint: 'Le fichier corrompu répond à un nom. Le terminal connaît DECRYPT.',
    ...
    steps: [
      {
        ...
        rpHint: 'Ils te voient. TRACE avant qu\'il ne soit trop tard.',
